Pod::Spec.new do |s|
  ...
  s.resources      =  'GimbalSDKiOS/ContextProfiling.embeddedframework/ContextProfiling.framework/Resources/*.txt',
                      'GimbalSDKiOS/ContextLocation.embeddedframework/ContextLocation.framework/Resources/*.bundle'
